...
export const BillingAddressSelector: React.FC<BillingAddressSelectorProps> = ({
  ...
  return (
    <Box>
      ...
      {shippingAddress && selectedFulfillmentMethod !== "in_store_pickup" && (
        <Box mb={2}>
          <FormControlLabel
            value="same"
            control={
                    ...
                    <Box display="flex" gap={1} width="100%">
                      <Box>
                        ...
                        >
                          ...
                          {(address.is_default || address.isDefaultBilling) && (
                            <Chip
                              label="Default"
                              size="small"
                              color="primary"
          ...
          {billingAddresses.length > ADDRESSES_PER_PAGE && (
            <Stack direction="row" spacing={2} alignItems="center">
              ...
              <Button
                ...
                disabled={
                  currentPage >=
                  Math.ceil(billingAddresses.length / ADDRESSES_PER_PAGE) - 1
                }
                size="small"
              >
                Next
