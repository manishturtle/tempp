...
export default function AccountsPageWrapper() {
  return (
    <AccountViewProvider>
      <DrawerProvider>
        <Suspense
          fallback={<div className="p-4">Loading accounts list...</div>}
        >
          <AccountsPage />
        </Suspense>
      </DrawerProvider>
...
function AccountsPage() {
  ...
  } = useFetchAccount(selectedAccount ? Number(selectedAccount.id) : null);
  ...
  const [activeContent, setActiveContent] = useState<
    "view" | "edit" | "activity" | "task" | "contacts" | "addresses"
  >("view");
  ...
  const tabOptions = useMemo(
    () => [
      { value: "all", label: t("status.all"), count: accountsData?.count || 0 },
      {
        ...
        count: accountsData?.active_count || 0,
      },
      {
        value: "Inactive",
        label: t("status.inactive"),
        count: accountsData?.inactive_count || 0,
      },
    ],
    [accountsData, t]
  );
  ...
  const columns: GridColDef[] = [
    {
      field: "id",
      headerName: t("field.id", "Customer ID"),
      sortable: true,
    },
    {
      field: "name",
      headerName: t("field.name", "Customer Name"),
      flex: 2,
      sortable: true,
      renderCell: (params) => (
        <Typography
    ...
    },
    {
      ...
      headerName: t("field.customerGroup", "Customer Group"),
      renderCell: (params) => (
        <Typography
          variant="body2"
          sx={{ color: "primary.main", fontWeight: 500 }}
        >
          {params.row.customer_group?.group_name}
        </Typography>
      ),
    },
    {
      field: "primary_phone",
      headerName: t("", "Website/Phone"),
      flex: 1,
      sortable: true,
      renderCell: (params) =>
        params.value ? (
          <>
            ...
            <Typography variant="body2">{params.row.website}</Typography>
          </>
        ) : (
          "-"
        ),
    ...
    >
      ...
      >
        ...
        <Button
          ...
          startIcon={<AddIcon />}
          onClick={() =>
            router.push(`/${tenant}/Crm/Masters/customers/accounts/new`)
          }
          sx={{
            textTransform: "none",
            fontWeight: 500,
            ...
            },
            {
              ...
              onClick: () => {
                ...
                if (selectedAccount?.id) {
                  setAccountId(selectedAccount.id);
                  router.push(
                    `/${tenant}/Crm/Masters/customers/accounts/edit/${selectedAccount.id}`
                  );
                }
              },
            },
        ...
        >
          {isLoadingAccountDetail ? (
            ...
            <Box>
              ...
              {accountDetail?.contacts && accountDetail.contacts.length > 0 ? (
                ...
                <Alert severity="info" sx={{ mb: 2 }}>
                  {t("info.noContacts") ||
                    "No contacts found for this account. Add a contact to get started."}
                </Alert>
              )}
            </Box>
            ...
            <Box>
              ...
              {accountDetail?.addresses &&
              accountDetail.addresses.length > 0 ? (
                <Stack spacing={2}>
                  {accountDetail.addresses.map((address) => (
                    ...
                    >
                      ...
                      >
                        <Typography variant="subtitle1" fontWeight="medium">
                          {t(
                            `addressType.${address.address_type?.toLowerCase()}`
                          ) ||
                ...
                <Alert severity="info">
                  {t("info.noAddresses") ||
                    "No addresses found for this account. Add an address to get started."}
                </Alert>
              )}
            </Box>
          ) : (
            <Box>
              ...
              >
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={
                    accountDetail?.legal_name ||
                    selectedAccount.legal_name ||
                    ""
                  }
                  disabled={!isEditMode}
                  size="small"
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={
                    accountDetail?.customer_group?.group_name ||
                    selectedAccount.customer_group?.group_name ||
                    ""
                  }
                  disabled={!isEditMode}
                  size="small"
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={
                    accountDetail?.customer_group?.group_type ||
                    selectedAccount.customer_group?.group_type ||
                    ""
                  }
                  disabled={!isEditMode}
                  size="small"
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={
                    accountDetail?.industry || selectedAccount.industry || ""
                  }
                  disabled={!isEditMode}
                  size="small"
                />
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={
                    accountDetail?.primary_phone ||
                    selectedAccount.primary_phone ||
                    ""
                  }
                  disabled={!isEditMode}
                  size="small"
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={
                    accountDetail?.website || selectedAccount.website || ""
                  }
                  disabled={!isEditMode}
                  size="small"
                />
                ...
                <TextField
                  ...
                  variant="outlined"
                  value={
                    accountDetail?.company_size ||
                    selectedAccount.company_size ||
                    ""
                  }
                  disabled={!isEditMode}
                  size="small"
