...
import EntityAutocomplete, {
  Entity,
} from "@/app/components/common/Autocomplete/EntityAutocomplete";
...
const accountCreateSchema = z.object({
  ...
  parent_account: z
    .union([z.string().optional(), z.number().int().positive().optional()])
    .optional(),
...
function AddressCreateDrawer({
  open,
  onClose,
  onSave,
  initialData,
}: AddressCreateDrawerProps) {
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  ...
                  {errors.address_type && (
                    <FormHelperText>
                      {t(errors.address_type.message || "field.required")}
                    </FormHelperText>
                  )}
                </FormControl>
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    errors.street_1
                      ? t(errors.street_1.message || "field.required")
                      : ""
                  }
                />
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    errors.street_2 ? t(errors.street_2.message || "") : ""
                  }
                />
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    errors.street_3 ? t(errors.street_3.message || "") : ""
                  }
                />
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    errors.city
                      ? t(errors.city.message || "field.required")
                      : ""
                  }
                />
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    errors.postal_code
                      ? t(errors.postal_code.message || "field.required")
                      : ""
                  }
                />
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  ...
                  {errors.country && (
                    <FormHelperText>
                      {t(errors.country.message || "field.required")}
                    </FormHelperText>
                  )}
                </FormControl>
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    errors.first_name
                      ? t(errors.first_name.message || "field.required")
                      : ""
                  }
                />
              )}
                ...
                <TextField
                  ...
                  helperText={
                    errors.secondary_email
                      ? t(errors.secondary_email.message || "")
                      : ""
                  }
                />
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    errors.work_phone ? t(errors.work_phone.message || "") : ""
                  }
                />
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <TextField
                  ...
                  helperText={
                    errors.job_title ? t(errors.job_title.message || "") : ""
                  }
                />
              )}
            />
            ...
            <Controller
              ...
              render={({ field }) => (
                <FormControl
                  ...
                  disabled={isViewMode}
                >
                  <InputLabel id="contact-status-label">
                    {t("Status")} *
                  </InputLabel>
                  <Select
                    {...field}
                  ...
                  {errors.status && (
                    <FormHelperText>
                      {t(errors.status.message || "field.required")}
                    </FormHelperText>
                  )}
                </FormControl>
              )}
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  ...
                  {errors.owner && (
                    <FormHelperText>
                      {t(errors.owner.message || "field.required")}
                    </FormHelperText>
                  )}
                </FormControl>
              )}
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <AccountViewProvider>
        <DrawerProvider>
          <Suspense
            fallback={<div className="p-4">Loading new account form...</div>}
          >
            <NewAccountForm />
          </Suspense>
        </DrawerProvider>
...
function NewAccountForm() {
  ...
  const {
    ...
    queryFn: async () => {
      const response = await api.get(
        `${entityEndpoints.customFieldDefinitions}?object_type=Account&is_active=true`,
        {
          headers: getAuthHeaders(),
        }
      );
  ...
  const isBusinessOrGovernmentGroup =
    groupType === "BUSINESS" || groupType === "GOVERNMENT";
  ...
  const accountCreateMutation = useMutation({
    ...
    onError: (error: any) => {
      ...
      setSnackbar({
        open: true,
        message:
          error.response?.data?.detail || t("accountCreatePage.errorMessage"),
        severity: "error",
      });
      ...
      if (error.response?.data?.errors) {
        ...
        Object.keys(apiErrors).forEach((field) => {
          if (field.startsWith("custom_fields.")) {
            ...
            setValue(
              `custom_fields.${customField}` as any,
  ...
  const validateCustomFields = (data: AccountFormData): boolean => {
    ...
    customFieldDefinitions.forEach((field) => {
      if (field.is_required && !customFields[field.field_name]) {
        ...
        setValue(
          `custom_fields.${field.field_name}` as any,
  ...
  const onSubmit = (data: AccountFormData) => {
    ...
    if (
      ...
      typeof payload.contract_start_date !== "string"
    ) {
      ...
      >
        ...
        <Stack direction="row" spacing={2}>
          <Button
            ...
            color="inherit"
            onClick={() =>
              router.push(`/${tenant}/Crm/Masters/customers/accounts`)
            }
              ...
              <Grid container spacing={2}>
                  ...
                  <EntityAutocomplete
                    ...
                    helperText={
                      errors.parent_account?.message
                        ? String(errors.parent_account.message)
                        : undefined
                    }
                        ...
                        try {
                          ...
                          if (response.data && response.data.customer_group) {
                            ...
                            setTimeout(() => {
                              setValue(
                                "customer_group",
                                response.data.customer_group.id
                              );
                            }, 0);
                          }
                        } catch (error) {
                          console.error(
                            "Error fetching parent account details:",
                            error
                          );
                        }
                      } else {
                ...
                <Grid size={{ xs: 12, md: 3 }}>
                  <EntityAutocomplete
                    ...
                    helperText={
                      watch("parent_account")
                        ? t("accountCreatePage.customerGroupInheritanceMessage")
                        : errors.customer_group?.message
                        ? String(errors.customer_group.message)
                        : undefined
                    }
                    getOptionLabel={(option) => option?.group_name || ""}
                    onChange={(value) => {
                      if (!watch("parent_account")) {
                        // Only allow changing if no parent account
                      ...
                      <TextField
                        ...
                        helperText={
                          errors.primary_phone?.message
                            ? String(errors.primary_phone.message)
                            : undefined
                        }
                      />
                    )}
                        ...
                        <TextField
                          ...
                          helperText={
                            errors.legal_name?.message
                              ? String(errors.legal_name.message)
                              : undefined
                          }
                        />
                      )}
                      ...
                      render={({ field }) => (
                        <FormControl fullWidth size="small">
                          ...
                          >
                            ...
                            <MenuItem value="201-500 employees">
                              {t("201-500 employees")}
                            </MenuItem>
                            <MenuItem value="501+ employees">
                              {t("501+ employees")}
                            </MenuItem>
                          </Select>
                        </FormControl>
            ...
            <Paper elevation={0} variant="outlined" sx={{ p: 3, mb: 3 }}>
              ...
              {isIndividualGroup && (
                ...
                >
                  <Typography variant="body2" color="text.secondary">
                    {t(
                      "For individual accounts, contact information is automatically created from account details."
                    )}
                  </Typography>
                </Box>
              )}
                          ...
                          switch (field.field_type) {
                            ...
                            case "PICKLIST":
                              return (
                                ...
                                >
                                  <InputLabel
                                    id={`custom-field-${field.field_name}-label`}
                                  >
                                    {field.label +
                                      (field.is_required ? " *" : "")}
                                  </InputLabel>
                      ...
                      <TextField
                        ...
                        helperText={
                          errors.customer_reference?.message
                            ? String(errors.customer_reference.message)
                            : undefined
                        }
                      />
                    )}
                        ...
                        slotProps={{
                          textField: {
                            ...
                            helperText: errors.contract_start_date?.message
                              ? String(errors.contract_start_date.message)
                              : undefined,
                          },
                        }}
                      />
